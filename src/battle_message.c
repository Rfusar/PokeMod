...
static const u8 sText_Trainer1LoseText[] = _("GAMEOVER! {PLAYER}");
static const u8 sText_PkmnGainedEXP[] = _("{B_BUFF1} {B_BUFF2}\n{B_BUFF3} EXP!\p");
static const u8 sText_EmptyString4[] = _("");
static const u8 sText_ABoosted[] = _(" a boosted");
static const u8 sText_PkmnGrewToLv[] = _("{B_BUFF1} sale al\nLV. {B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_PkmnLearnedMove[] = _("{B_BUFF1} impara\n{B_BUFF2}!{WAIT_SE}\p");
static const u8 sText_TryToLearnMove1[] = _("{B_BUFF1} tenta\nd'imparare {B_BUFF2}.\p");
static const u8 sText_TryToLearnMove2[] = _("{B_BUFF1} non può\npiù di 4 mosse\p");
static const u8 sText_TryToLearnMove3[] = _("disimpara una mossa\nper {B_BUFF2}?");
static const u8 sText_PkmnForgotMove[] = _("{B_BUFF1} dimentica cosi...\n{B_BUFF2}.\p");
static const u8 sText_StopLearningMove[] = _("{PAUSE 32} ferma allenamento\n{B_BUFF2}?");
static const u8 sText_DidNotLearnMove[] = _("{B_BUFF1} non ha imparato\n{B_BUFF2}.\p");
static const u8 sText_UseNextPkmn[] = _("Vuoi Switchare\nPOKèMON?");
static const u8 sText_AttackMissed[] = _("{B_ATK_NAME_WITH_PREFIX} fallito.");
static const u8 sText_PkmnProtectedItself[] = _("{B_DEF_NAME_WITH_PREFIX}\nsi protegge!");
static const u8 sText_AvoidedDamage[] = _("{B_DEF_NAME_WITH_PREFIX} avoided\ndamage with {B_DEF_ABILITY}!");
static const u8 sText_PkmnMakesGroundMiss[] = _("{B_DEF_NAME_WITH_PREFIX} makes GROUND\nmoves miss with {B_DEF_ABILITY}!");
static const u8 sText_PkmnAvoidedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} attacco\na vuoto!");
static const u8 sText_ItDoesntAffect[] = _("Non ha effetto\n{B_DEF_NAME_WITH_PREFIX}…");
...
static const u8 sText_CantEscape2[] = _("AHahah Ndo vai?!?!\p");
static const u8 sText_AttackerCantEscape[] = _("{B_ATK_NAME_WITH_PREFIX} nono!");
static const u8 sText_HitXTimes[] = _("colpisce {B_BUFF1} volta(e)!");
static const u8 sText_PkmnFellAsleep[] = _("{B_EFF_NAME_WITH_PREFIX}\nli sale la para!");
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nrende {B_EFF_NAME_WITH_PREFIX} sleep!");
...
static const u8 sText_PkmnHurtByPoison[] = _("{B_ATK_NAME_WITH_PREFIX} li salgono\ni dubbi!");
static const u8 sText_PkmnAlreadyPoisoned[] = _("{B_DEF_NAME_WITH_PREFIX} è gia\navvelenato.");
static const u8 sText_PkmnBadlyPoisoned[] = _("{B_EFF_NAME_WITH_PREFIX} è in botta\nassurda!");
...
static const u8 sText_PkmnHurtByBurn[] = _("{B_ATK_NAME_WITH_PREFIX} è ustionato!");
static const u8 sText_PkmnAlreadyHasBurn[] = _("{B_DEF_NAME_WITH_PREFIX} è cotto");
...
static const u8 sText_PkmnIsAlreadyParalyzed[] = _("{B_DEF_NAME_WITH_PREFIX} è gia paralizzato!");
...
static const u8 sText_PkmnIsConfused[] = _("{B_ATK_NAME_WITH_PREFIX} è in para!");
static const u8 sText_PkmnHealedConfusion[] = _("{B_ATK_NAME_WITH_PREFIX} snapped\nout of confusion!");
static const u8 sText_PkmnWasConfused[] = _("{B_EFF_NAME_WITH_PREFIX} diventa incerto");
static const u8 sText_PkmnAlreadyConfused[] = _("{B_DEF_NAME_WITH_PREFIX} è davvero in botta");
static const u8 sText_PkmnFellInLove[] = _("{B_DEF_NAME_WITH_PREFIX}\ns'innamora");
static const u8 sText_PkmnInLove[] = _("{B_ATK_NAME_WITH_PREFIX}: ammore... {B_SCR_ACTIVE_NAME_WITH_PREFIX}!");
static const u8 sText_PkmnImmobilizedByLove[] = _("{B_ATK_NAME_WITH_PREFIX}: No, ammore mio!");
...
static const u8 sText_PkmnEvadedAttack[] = _("{B_DEF_NAME_WITH_PREFIX} evade l'attacco!");
static const u8 sText_PkmnSappedByLeechSeed[] = _("{B_ATK_NAME_WITH_PREFIX}'s semisemi... LEECH SEED!");
...
static const u8 sText_TrainerBlockedBall[] = _("Cazzo fai fra?!?!");
static const u8 sText_DontBeAThief[] = _("Incivile");
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown BALL!\nThis POKéMON can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("Hai mancato il POKèMON\nhihi, Stupida!");
static const u8 sText_PkmnBrokeFree[] = _("Il POKéMON si è liberato,\ncosa farai adesso {PLAYER}?");
static const u8 sText_ItAppearedCaught[] = _("Aww!");
static const u8 sText_AarghAlmostHadIt[] = _("Aargh!\nAlmost had it!");
static const u8 sText_ShootSoClose[] = _("AHhahahah");
static const u8 sText_GotchaPkmnCaughtPlayer[] = _("Gotcha!\n{B_OPPONENT_MON1_NAME} era preso!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaughtWally[] = _("Gotcha!\n{B_OPPONENT_MON1_NAME} era preso!{WAIT_SE}{PLAY_BGM MUS_CAUGHT}{PAUSE 127}");
static const u8 sText_GiveNicknameCaptured[] = _("Vuoi dargli un nome\n a {B_OPPONENT_MON1_NAME}?");
static const u8 sText_PkmnSentToPC[] = _("{B_OPPONENT_MON1_NAME} ha spedito a\n{B_PC_CREATOR_NAME} PC.");
...
static const u8 sText_ItIsRaining[] = _("Sta piovendo...");
static const u8 sText_SandstormIsRaging[] = _("Cazzo non ci vedo niente...");
static const u8 sText_BoxIsFull[] = _("Il BOX è full baby...\p");
...
const u8 gText_PkmnIsEvolving[] = _("{STR_VAR_1}: uuuaaAAHHHH");
const u8 gText_CongratsPkmnEvolved[] = _("{STR_VAR_1}\nsi è evoluto in {STR_VAR_2}!{WAIT_SE}\p");
const u8 gText_PkmnStoppedEvolving[] = _("{STR_VAR_1}: Merda!\p");
const u8 gText_EllipsisQuestionMark[] = _("……?\p");
const u8 gText_WhatWillPkmnDo[] = _("{B_ACTIVE_NAME_WITH_PREFIX}:\nCapo cosa devo fare?");
const u8 gText_WhatWillPkmnDo2[] = _("Cosa farà {B_PLAYER_NAME}?");
const u8 gText_WhatWillWallyDo[] = _("Cosa farà WALLY?");
...
const u8 gText_WhichMoveToForget4[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Con quale vorresti cambiare?");
const u8 gText_BattleYesNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Yes\nNo");
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Quale cambi?");
